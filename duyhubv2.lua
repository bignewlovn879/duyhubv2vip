...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Script By DUY HUB UPDATE THÀNH CÔNG<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>ANTI-CHEAT-ON<Color=/>"):Display()
    wait(.14)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Hãy sử dụng Fluxus để có trải nghiệm tốt!!<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("Admin Script Cảm Ơn Anh em<Color=/>"):Display()
    wait(.29)
...
local Window = OrionLib:MakeWindow({Name = "DUY HUB", HidePremium = false, IntroText = "DUY HUB Library", SaveConfig = true, ConfigFolder = "DUY HUB"})
...
OrionLib:MakeNotification({
	Name = "DUY HUB",
	Content = "DUY HUB Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("Script By NGUYỄN VŨ DUY")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] DUY HUB is back!")
